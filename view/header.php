...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="public/css/bootstrap-datetimepicker-standalone.css">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">ZentGroup</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php"><i class="fa fa-user fa-fw"></i>Quản lý người dùng</a>
                        </li>
                        <li>
                            <a href="index.php?mod=post"><i class="fa fa-book fa-fw"></i>Quản lý bài viết</a>
                        </li>
                        <li>
                            <a href="index.php?mod=tags"><i class="fa fa-tag fa-fw"></i>Quản lý tag</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
